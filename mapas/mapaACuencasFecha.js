...
var untiled = new ol.layer.Image({
        ...
        source: new ol.source.ImageWMS({
	          ...
	          params: {'FORMAT': format,viewparams:'p_fecha:' + pDateSelected ,
	                   'VERSION': '1.1.1',  
	                LAYERS: 'wspCirsa:sgaViewEstacionesFecha',
	                STYLES: ''
	          }
        })
      });
 ...
 var untiledCuencas = new ol.layer.Image({
	maxResolution: 136000,
        source: new ol.source.ImageWMS({
          ...
          params: {'FORMAT': format,viewparams:'p_fecha:' + pDateSelected ,
                   'VERSION': '1.1.1',  
                LAYERS: 'wspCirsa:sgaViewAlertasCuencasFecha',
                STYLES: '',
          }
        })
      });
...
var map = new ol.Map({
  controls:controls,
  layers: [untiledCuencas,untiled,untiledDrenaje],
  interactions: ol.interaction.defaults({
    altShiftDragRotate: false,
    dragPan: false,
    rotate: false, pinchRotate:false
