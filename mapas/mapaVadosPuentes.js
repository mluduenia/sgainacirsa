...
var pDateSelected = document.getElementById('frmMapa:refreshDate_input').value;
...
var untiled = new ol.layer.Image({
	source : new ol.source.ImageWMS({
		...
		params : {
			'FORMAT' : format,
			'VERSION' : '1.1.1',
			LAYERS : 'wspCirsa:sgaViewVadosPuentes',
			STYLES : '',
		}
	})
});
...
function refreshLayer() {
	var viewparams = [ 't:' + new Date().getMilliseconds() ];
